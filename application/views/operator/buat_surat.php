 					...
 					<div class="tab-content">
 									...
 									<div class="col-md-6">
 										<div class="form-group">
 											...
 											<select name="tembusan" id="tembusan" onchange="lain_tembusan()" class="form-control">
 												<option value="">------------</option>
 												<option value="Kepala Desa Sukapura">Kepala Dinas Palangka Raya</option>
 												<option value="Kepala Desa Dayeuhkolot">Walikota Palangka Raya</option>
 												<option value="Lain-lain">Lain-lain</option>
 											</select>
 						...
 						<div class="tab-pane  p-20" id="profile2" role="tabpanel" >
 							<div class="col-md-12 p-4" id="print" style="padding-top: 20px; padding-right: 50px; padding-left: 50px; box-shadow: 1px 1px 10px gray;min-height: 1250px;">
 										...
 										<div class="media-body media-search">
 											<div class="row">
 												<table class="table" width="100%">
 													<tr>
 														<td width="20%"><img src="tangan-dadah.png" alt="" width="100"></td>
 														<td>
 															<center>
 																...
 																<h2 style="margin: 0;font-family: sans-serif;">KANTOR DUKCAPIL</h2>
 								...
 								<p style="float: right;  margin-top:600px; right: 60px;">DINAS KEPENDUDUKAN PALANGKA RAYA</p>
 								<p style="float: right; margin-top:690px; margin-right: -160px; text-align: center;"><u><b>PUTRA AISYIFA MASHUDA, M.Kom</b></u><br>Pembina Tk. I(IV/b) <br> NIP : 19670122 199003 1 001</p>
